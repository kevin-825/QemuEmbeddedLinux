/*
 * Auto-generated UAPI header for primitive_lab_1
 * Author: Kevin
 * Date: 
 * Description: User-Space API (UAPI) contract for primitive_lab_1.
 */

#ifndef _UAPI_LINUX_PRIMITIVE_LAB_1_H_
#define _UAPI_LINUX_PRIMITIVE_LAB_1_H_
...
struct primitive_lab_1_config {
    __u32 sample_rate;
    __u32 active_channels;
};

struct primitive_lab_1_data {
 ...
 */
#define PRIMITIVE_LAB_1_IOC_MAGIC  'K'
...
#define PRIMITIVE_LAB_1_IOC_RESET       _IO(PRIMITIVE_LAB_1_IOC_MAGIC, 0)

/* Command 1: Write a configuration struct TO the driver */
#define PRIMITIVE_LAB_1_IOC_SET_CONFIG  _IOW(PRIMITIVE_LAB_1_IOC_MAGIC, 1, struct primitive_lab_1_config)

/* Command 2: Read a data struct FROM the driver */
#define PRIMITIVE_LAB_1_IOC_GET_DATA    _IOR(PRIMITIVE_LAB_1_IOC_MAGIC, 2, struct primitive_lab_1_data)

/* Command 3: Send a simple 32-bit integer and get a status integer back */
#define PRIMITIVE_LAB_1_IOC_CALIBRATE   _IOWR(PRIMITIVE_LAB_1_IOC_MAGIC, 3, __u32)
...
#endif /* _UAPI_LINUX_PRIMITIVE_LAB_1_H_ */
