/*
 * Auto-generated UAPI header for m_HelloMod
 * Author: Kevin
 * Date: 
 * Description: User-Space API (UAPI) contract for m_HelloMod.
 */

#ifndef _UAPI_LINUX_M_HELLOMOD_H_
#define _UAPI_LINUX_M_HELLOMOD_H_
...
struct m_HelloMod_config {
    __u32 sample_rate;
    __u32 active_channels;
};

struct m_HelloMod_data {
...
#define M_HELLOMOD_IOC_RESET       _IO(M_HELLOMOD_IOC_MAGIC, 0)

/* Command 1: Write a configuration struct TO the driver */
#define M_HELLOMOD_IOC_SET_CONFIG  _IOW(M_HELLOMOD_IOC_MAGIC, 1, struct m_HelloMod_config)

/* Command 2: Read a data struct FROM the driver */
#define M_HELLOMOD_IOC_GET_DATA    _IOR(M_HELLOMOD_IOC_MAGIC, 2, struct m_HelloMod_data)

/* Command 3: Send a simple 32-bit integer and get a status integer back */
#define M_HELLOMOD_IOC_CALIBRATE   _IOWR(M_HELLOMOD_IOC_MAGIC, 3, __u32)
...
#endif /* _UAPI_LINUX_M_HELLOMOD_H_ */
